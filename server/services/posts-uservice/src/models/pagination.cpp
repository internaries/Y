...
userver::storages::postgres::ResultSet PaginationRequest::GetPostsFromDb(const userver::storages::postgres::ClusterPtr& db, const std::string& table, const std::string& search_id) {
